...
http://www.opengis.net/spec/geosciml%2F4.1%2Freq%2F%5BclassM%5D[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]++]

The URI for each requirement or recommendation has the form:

http://www.opengis.net/spec/geosciml%2F4.1%2Freq%2F%5BclassM%5D%2F%5BreqN%5D[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]/++[++reqN++]]


The URI for each conformance class has the form:

http://www.opengis.net/spec/geosciml%2F4.1%2Fconf%2F%2B%2B%5B%2B%2BclassM%2B%2B%5D%2B%2B[\http://www.opengis.net/spec/geosciml/4.1/conf/++[++classM++]++]


The URI for each conformance test has the form:

http://www.opengis.net/spec/geosciml%2F4.1%2Fconf%2F%2B%2B%5B%2B%2BclassM%2B%2B%5D%2B%2B%2F%2B%2B%5B%2B%2BtestN%2B%2B%5D%2B%2B[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]/++[++testN++]]
