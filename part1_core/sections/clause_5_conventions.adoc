...
http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]++[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]++]

The URI for each requirement or recommendation has the form:

http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]++/++[++reqN++]++[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]/++[++reqN++]]


The URI for each conformance class has the form:

http://www.opengis.net/spec/geosciml/4.1/conf/++[++classM++]++[\http://www.opengis.net/spec/geosciml/4.1/conf/++[++classM++]++]


The URI for each conformance test has the form:

http://www.opengis.net/spec/geosciml/4.1/conf/++[++classM++]++/++[++testN++]++[\http://www.opengis.net/spec/geosciml/4.1/req/++[++classM++]/++[++testN++]]
