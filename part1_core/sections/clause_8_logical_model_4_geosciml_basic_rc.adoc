...
image::images/image10.png[GeoSciML Basic dependencies.,width=601,height=455]Figure: 10: GeoSciML Basic dependencies.
...
image::images/image11.png[Geologic Feature and MappedFeature.,width=601,height=366]Figure: 11: Geologic Feature and MappedFeature.
...
image::images/image12.png[Geologic Feature context diagram,width=601,height=332]Figure: 12: Geologic Feature context diagram
...
image::images/image13.png[GeologicUnit context diagram.,width=601,height=367]Figure: 13: GeologicUnit context diagram.
...
image::images/image14.png[EarthMaterial and related classes.,width=516,height=238]Figure: 14: EarthMaterial and related classes.
...
image::images/image15.png[Context diagram for CompoundMaterial,width=601,height=469]Figure: 15: Context diagram for CompoundMaterial
...
image::images/image16.png[ Geologic Event summary diagram.,width=601,height=511]Figure: 16: Geologic Event summary diagram.
...
image::images/image17.png[Summary diagram of Geologic structures.,width=601,height=366]Figure: 17: Summary diagram of Geologic structures.
...
image::images/image18.png[Contact context diagram,width=601,height=648]Figure: 18: Contact context diagram
...
image::images/image19.png[Fold context diagram.,width=601,height=637]Figure: 19: Fold context diagram.
...
image::images/image20.png[Foliation context diagram,width=601,height=635]Figure: 20: Foliation context diagram
...
image::images/image21.png[ShearDisplacementStructure context diagram,width=601,height=654]Figure: 21: ShearDisplacementStructure context diagram
...
image::images/image22.png[Geomorphologic feature summary diagram,width=601,height=417]Figure: 22: Geomorphologic feature summary diagram
...
image::images/image24.png[GSML collection summary diagram.,width=601,height=538]Figure: 24: GSML collection summary diagram.
...
a)     by materializing the GSMLItem  (as prescribed by ISO 19136) +
 +
image::images/image25.png[extracted-media/media/image25,width=486,height=62]

b)    using GSMLItem as a validation constraint

image::images/image26.png[extracted-media/media/image26,width=292,height=70]
...
image::images/image27.png[Summary diagram of specialised GeoSciML data types,width=601,height=685]Figure: 25: Summary diagram of specialised GeoSciML data types
...
image::images/image28.png[Context diagram for QuantityRange making lower and upper values explicit,width=260,height=635]Figure: 26: Context diagram for QuantityRange making lower and upper values explicit
...
image::images/image29.png[Encoding of a quantity range of ++[++15.6,26.7++]++.  Note that the value is encoded in both lowerValue, upperValue and in value as an array.,width=166,height=126]Figure: 27: Encoding of a quantity range of ++[++15.6,26.7++]++.  Note that the value is encoded in both lowerValue, upperValue and in value as an array.
...
image::images/image30.png[Excerpt from Drewes map ++[++3++]++ with a Dacitic vent breccia unit highlighted (Ttv),width=601,height=455]Figure: 28: Excerpt from Drewes map ++[++3++]++ with a Dacitic vent breccia unit highlighted (Ttv)

image::images/image31.png[Original description from Drewes map ++[++3++]++ legend.  This legend item is represented as a GeologicFeature (specifically, a GeologicUnit),width=601,height=254]Figure: 29: Original description from Drewes map ++[++3++]++ legend.  This legend item is represented as a GeologicFeature (specifically, a GeologicUnit)

The map also has a cross section through the same Ttv unit (Figure 30) showing an example of a non-map mapping frame.

image::images/image32.png[The same Dacitic vent breccia unit, shown in a cross section (a different MappingFrame),width=601,height=209]Figure: 30: The same Dacitic vent breccia unit, shown in a cross section (a different MappingFrame)

image::images/image33.png[Partial encoding of the Dacitic vent breccia unit from Drewes’ map ++[++3++]++ partitioned into GeoSciML instances.,width=601,height=484]Figure: 31: Partial encoding of the Dacitic vent breccia unit from Drewes’ map ++[++3++]++ partitioned into GeoSciML instances.
