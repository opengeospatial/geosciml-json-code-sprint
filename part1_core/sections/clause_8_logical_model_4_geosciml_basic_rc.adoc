...
<<img_partial_encoding_of_landform>> shows an example of GeoSciML encoding of a landform lava cone geomorphologic unit (from ++[++2++]++) located in Elba Island showing how the geomorphologic feature is related to the geologic unit and materials that it is made of.
