...
include::/requirements/requirements_class_borehole.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_value-intervalBegin.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_drill-interval-1D.adoc[]
 


include::/requirements/borehole/REQ_gsml-borehole_drill-interval-1D-CRS.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_value-mappedIntervalBegin.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_interval-1D.adoc[]


include::/requirements/borehole/REQ_gsml-borehole_interval-1D-CRS.adoc[]

Instance example for Klčovo and Lastomir Formation adapted from Túnyi ++[++<<B18,18>>++]++:

[[img_top__part_tunyi]]
.Top part of Figure 2 from Túnyi ++[++<<B18,18>>++]++
...
include::/requirements/borehole/REQ_gsml-borehole_borehole-position-null.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_borehole-3d.adoc[]
...
include::/requirements/borehole/REQ_gsml-borehole_borehole-elevation-dim.adoc[]


include::/requirements/borehole/REQ_gsml-borehole_borehole-elevation-CRS.adoc[]
