...
<<img_lite_feature_types>> shows the seven Lite feature types specified by GeoSciML {edition}.  Each feature type is equivalent to a layer in a GIS or a Web Map Service. 
...
[width="100%",cols=",",options="header",align="left"]
|===
|*Property* |*Mapping from MappedFeature*
|*identifier* |identifier
