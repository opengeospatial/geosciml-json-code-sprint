...
image::images/image34.png[GeoSciML extension package dependencies.,width=601,height=609]Figure: 32: GeoSciML extension package dependencies.

==== GeologicRelation

image::images/image35.png[Summary diagram of GeologicFeatureRelation as a concrete subtype of AbstractFeatureRelation stub class,width=532,height=617]Figure: 33: Summary diagram of GeologicFeatureRelation as a concrete subtype of AbstractFeatureRelation stub class
...
image::images/image36.png[Generic geologic feature relation,width=546,height=385]Figure: 34: Generic geologic feature relation
...
image::images/image37.png[Material relation context diagram.,width=531,height=544]Figure: 35: Material relation context diagram.
...
image::images/image38.png[Overview of earth material description.,width=601,height=427]Figure: 36: Overview of earth material description.

===== AlterationDescription

image::images/image39.png[Alteration description context diagram.,width=531,height=570]Figure: 37: Alteration description context diagram.
...
image::images/image40.png[Example of a weathering profile.,width=486,height=143]Figure: 38: Example of a weathering profile.

An example encoding of an altered geologic unit from Drewes ++[++3++]++ is shown in Figure 39.

image::images/image41.png[Example of describing alteration halo from Drewes ++[++3++]++.,width=601,height=390]Figure: 39: Example of describing alteration halo from Drewes ++[++3++]++.
...
image::images/image42.png[Chemical composition context diagram.,width=525,height=339]Figure: 40: Chemical composition context diagram.
...
image::images/image43.png[Compound material description context diagram.,width=601,height=533]Figure: 41: Compound material description context diagram.
...
image::images/image44.png[ParticleGeometry context diagram.,width=273,height=453]Figure: 42: ParticleGeometry context diagram.
...
image::images/image45.png[ConstituentPart context diagram.,width=601,height=691]Figure: 43: ConstituentPart context diagram.
...
image::images/image46.png[Fabric description context diagram.,width=456,height=347]Figure: 44: Fabric description context diagram.
...
image::images/image47.png[Inorganic fluid context diagram.,width=308,height=363]Figure: 45: Inorganic fluid context diagram.
...
image::images/image48.png[Metamorphic description context diagram.,width=601,height=639]Figure: 46: Metamorphic description context diagram.
...
image::images/image49.png[Organic material context diagram.,width=311,height=352]Figure: 47: Organic material context diagram.
...
image::images/image50.png[Organism context diagram.,width=276,height=456]Figure: 48: Organism context diagram.
...
image::images/image51.png[Physical description context diagram.,width=553,height=540]Figure: 49: Physical description context diagram.
...
image::images/image52.png[Rock material description context diagram.,width=271,height=730]Figure: 50: Rock material description context diagram.
...
image::images/image53.png[GeologicAgeDetails summary diagram.,width=548,height=726]Figure: 51: GeologicAgeDetails summary diagram.
...
image::images/image54.png[Summary diagram for GeologicStructureDetails.,width=601,height=471]Figure: 52: Summary diagram for GeologicStructureDetails.
...
image::images/image55.png[ContactDescription context diagram.,width=601,height=543]Figure: 53: ContactDescription context diagram.
...
image::images/image56.png[DisplacementEvent context diagram,width=391,height=575]Figure: 54: DisplacementEvent context diagram
...
image::images/image57.png[Layering context diagram,width=552,height=440]Figure: 55: Layering context diagram
...
image::images/image58.png[Displacement value subtypes context diagram.,width=601,height=545]Figure: 56: Displacement value subtypes context diagram.
...
image::images/image59.png[FoldDescription context diagram.,width=601,height=557]Figure: 57: FoldDescription context diagram.
...
image::images/image60.png[FoldSystem context diagram.,width=601,height=611]Figure: 58: FoldSystem context diagram.
...
image::images/image61.png[FoliationDescription context diagram.,width=601,height=644]Figure: 59: FoliationDescription context diagram.
...
image::images/image62.png[ShearDisplacementStructureDescription context diagram.,width=601,height=447]Figure: 60: ShearDisplacementStructureDescription context diagram.
...
image::images/image63.png[GeologicUnitDetails,width=338,height=726]Figure: 61: GeologicUnitDetails
